...
public class ReadXLS {
    ...
    public Object[][] readSheet(Method method) throws IOException {
        ...
        File file = new File("C:\\Users\\Botit\\Desktop\\Botit Website\\Botit\\IdeaProjects\\IdeaProjects\\IdeaProjects\\Botit\\src\\testData\\testdata.xlsx");
       ...
       for (int i =1;i<=totalRows;i++){
        ...
        //testData[1][1] = format.formatCellValue(sheetName.getRow(1).getCell(1));
        return testData;
